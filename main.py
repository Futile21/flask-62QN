...
def encode_image(PicName):
    PicDIR= os.path.join(app_Dir, "picture", PicName+".png")
                    ...
                    dbc.Col(
                        html.Div([
                                dbc.RadioItems(
                                        id='RadioPower',
                                        options=[
                                            {'label': 'Capacity Factor', 'value': "CF", },
                                            {'label': 'Wind Power', 'value': "WindPower", }, ],
                                        value='CF',
                                        inline=True,
...
WindDF=pd.read_csv(os.path.join(app_Dir,'data', 'Test_CF003.csv'))
RoseDF=pd.read_csv(os.path.join(app_Dir,'data', 'Test_Rose003.csv'))
TurbDF=pd.read_csv(os.path.join(app_Dir,'data', 'PowerTurb4.csv'))
...
def updateMapRSA(n_clicks,PowerType,Turb,Height,Maplayout):
    # DataDisplayed=Turb+"-"+PowerType+"-"+Height
